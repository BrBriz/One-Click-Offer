    ...
    function createSetting() {
        ...
        if (navigation_bar) {
            ...
            settings_button.addEventListener("click", () => {
                ...
                function createSection(activeTab = 'boco') {
                    ...
                    btn1.style.background = activeTab === 'boco' ? '#e0e0e0' : 'transparent';
                    ...
                    btn2.style.background = activeTab === 'wallpaper' ? '#e0e0e0' : 'transparent';
